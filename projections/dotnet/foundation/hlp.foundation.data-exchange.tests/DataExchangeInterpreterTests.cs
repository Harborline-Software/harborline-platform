...
public sealed class DataExchangeInterpreterTests
{
    ...
    public async Task Dry_run_acquires_maps_and_protects_payload_without_writing_records()
    {
        ...
        var interpreter = new DataExchangeInterpreter(
            capabilities,
            new DataExchangeRuntime(runs, TimeProvider.System, new FakeLifecyclePolicy()),
            payloads);
    ...
    public async Task Invalid_row_is_recorded_as_rejected_and_later_rows_are_still_proposed()
    {
        ...
        var policies = new FakeSourcePolicies
        {
            Policy = new AcknowledgementPolicy(
                ...
                new HashSet<ExchangeEffectStatus>
                {
                    ExchangeEffectStatus.Failed,
                    ExchangeEffectStatus.Halted,
                }),
        };
...
internal sealed class CapturingTarget : FakeTargetCommandPort, ITargetAccessGate
{
