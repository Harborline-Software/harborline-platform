...
public sealed class CommitBoundsAndFailureTests
{
    ...
    private static DataExchangeCommitter CreateCommitter(
        ...
        ICanonicalRecordsCommandPort target,
        CommitBounds bounds)
        => new(
            runs,
...
internal sealed class ConcurrencyTarget : ITargetAccessGate, ICanonicalRecordsCommandPort
{
    private int _active;
    ...
    public async ValueTask<EffectTerminalOutcome> ApplyAsync(
...
internal sealed class ThrowOnceTarget : ITargetAccessGate, ICanonicalRecordsCommandPort
{
