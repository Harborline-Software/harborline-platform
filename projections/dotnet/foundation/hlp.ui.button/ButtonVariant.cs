namespace Harborline.Foundation.Enums;
...
public enum ButtonVariant
{
    ...
    /// Fluent v9 → <c>hl-btn-subtle</c> (native <c>fui-Button--subtle</c> token ladder);
    /// Bootstrap 5 → <c>btn-outline-secondary</c> (no native <c>btn-subtle</c>, documented semantic compromise);
    /// Material 3 → <c>hl-btn-subtle</c> (M3 text button).
    /// </summary>
    Subtle,
    ...
    /// Provider mapping:
    /// Fluent v9 → <c>hl-btn-transparent</c> (native <c>fui-Button--transparent</c>);
    /// Bootstrap 5 → <c>btn-link</c> (native link-styled button);
    /// Material 3 → <c>hl-btn-transparent</c> (M3 text button).
    /// </summary>
    Transparent,
    ...
    /// Fluent v9 → <c>hl-btn-light</c> (subtle on neutral surface);
    /// Material 3 → <c>hl-btn-light</c> (outlined on neutral surface).
    /// </summary>
    Light,
    ...
    /// Fluent v9 → <c>hl-btn-dark</c> (subtle on neutral-inverted surface);
    /// Material 3 → <c>hl-btn-dark</c> (filled on inverse-surface).
    /// </summary>
    Dark
}
