...
/// Authority segment of the units' <see cref="Harborline.Foundation.Assets.Common.EntityId"/>
...
/// <param name="TenantId">First (primary) tenant party on the current lease (a <see cref="PartyId"/>), or null when vacant.</param>
...
/// <c>// TODO(cross-cluster): populate from payment history once the legacy receivables package exposes per-lease payment events.</c>
/// </param>
...
/// Approximated from <see cref="Harborline.Blocks.Reports.Inputs.LeasePhase"/> in this substrate pass.
/// </summary>
