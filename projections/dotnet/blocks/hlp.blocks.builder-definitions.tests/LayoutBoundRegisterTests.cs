...
public sealed class LayoutBoundRegisterTests
{
    ...
    {
        LayoutDefinitionAdmission.ValidateForPublish(Sealed(GuardSurface("{\"==\":[{\"var\":\"field.status\"},\"open\"]}", "{\"==\":[{\"var\":\"row.status\"},\"open\"]}")), LayoutHostRegisters.Platform, LayoutTestAccess.GrantsAll);
        ...
        LayoutDefinitionAdmission.ValidateForAuthoring(GuardSurface("status == open", null), LayoutHostRegisters.Platform, LayoutTestAccess.GrantsAll);
    }
    ...
    public void ShowWhenFunctionsResolveOnlyThroughTheKernelRegister()
    {
        ...
        LayoutDefinitionAdmission.ValidateForPublish(Sealed(GuardSurface(
            ...
            "{\">\":[{\"date.diff\":[{\"date.today\":[]},{\"var\":\"row.due\"}]},30]}")), LayoutHostRegisters.Platform, LayoutTestAccess.GrantsAll);
