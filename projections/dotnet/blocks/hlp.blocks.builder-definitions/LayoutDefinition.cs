...
/// <param name="SubmitGate">The optional submit gate, the shared <c>hlp.contracts.authorization</c> type (layout-auth-23): exactly one of a role, a standing or an authorization capability. Refused on a surface that pins a form (layout-ck-31).</param>
