...
export default {
  resolve: { alias: {
    react: resolve(aggregateRoot, 'node_modules/react'), 'react-dom': resolve(aggregateRoot, 'node_modules/react-dom'),
    clsx: resolve(aggregateRoot, 'node_modules/clsx'), 'tailwind-merge': resolve(aggregateRoot, 'node_modules/tailwind-merge'),
