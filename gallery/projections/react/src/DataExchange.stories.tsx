...
const draft: DataExchangeAuthoringDraft = {
  name: 'Customer intake', sourceCapability: 'files.csv', connectorVersion: '2.4.0', secretReference: 'secretref:customer-intake',
  ...
  externalKeyColumns: ['CustomerNumber'], replayPolicy: 'deduplicate', scheduleReference: 'schedule.daily',
}
