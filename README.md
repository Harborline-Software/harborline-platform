...
Harborline's domain models, execution and human interfaces. Conformance checks assess implementations against those contracts.

The [product purpose](PRODUCT.md) explains the users and design principles. The
[domain language](CONTEXT.md) defines module, interface, projection and related terms.
...
The [gate implementation](tooling/run-phase-4-gate.mjs) defines the checks and prerequisites for
this checkout. Consult it when preparing an environment or investigating a failure.
